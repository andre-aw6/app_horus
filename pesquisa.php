...
$campo = (isset($_GET['filtro'])) ? $_GET['filtro'] : '';
      ...
      <div class="container pt-5">
        ...
        <div class="card card-outline-secondary">
            <div class="card-header">
              <div class="row">
                <div class="col-md-8">
                    <h3 class="mb-0">Alunos - Horus Crossfit</h3><br>
                    <h6 class="mb-0">                    </h6>
                </div>

                <div class="col-md-4 pull-left">
                   <form class="form-inline d-flex justify-content-end" action="pesquisa.php" method="get">
                        <input class="form-control mr-sm-0" type="text" id="campo" name="campo" placeholder="Pesquisar" aria-label="Search">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $alunos['situacao_aluno']; ?></td>
