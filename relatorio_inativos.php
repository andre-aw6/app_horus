  ...
  <div class="container pt-5">
    ...
    <div class="card card-outline-secondary">
        <div class="card-header">
          <div class="row">
            <div class="col-md-8">
                <h3 class="mb-0">Relatório de Data de Vencimentos - Hórus Crossfit</h3><br>
                <h6 class="mb-0">                    </h6>
              </div>
        ...
        <div class="col-md-4 pull-left">
           <form class="form-inline d-flex justify-content-end" method="post">
             ...
             <input class="btn btn-outline-danger my-2 my-sm-0" type="submit" value="Filtrar">
           </form>
         </div>
       </div>
     </div>
